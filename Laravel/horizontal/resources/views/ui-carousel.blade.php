                                ...
                                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel" data-interval="3000">
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <img class="d-block img-fluid" src="{{url('/')}}/assets/images/small/img-1.jpg" alt="First slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block img-fluid" src="{{url('/')}}/assets/images/small/img-2.jpg" alt="Second slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block img-fluid" src="{{url('/')}}/assets/images/small/img-3.jpg" alt="Third slide">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <img class="d-block img-fluid" src="{{url('/')}}/assets/images/small/img-4.jpg" alt="First slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block img-fluid" src="{{url('/')}}/assets/images/small/img-5.jpg" alt="Second slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block img-fluid" src="{{url('/')}}/assets/images/small/img-6.jpg" alt="Third slide">
                                        </div>
                                    </div>
                        ...
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <div id="carouselExampleCaption" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <img src="{{url('/')}}/assets/images/small/img-7.jpg" alt="...">
                                        ...
                                        <div class="carousel-item">
                                            <img src="{{url('/')}}/assets/images/small/img-5.jpg" alt="...">
                                            <div class="carousel-caption d-none d-md-block">
                                        ...
                                        <div class="carousel-item">
                                            <img src="{{url('/')}}/assets/images/small/img-4.jpg" alt="...">
                                            <div class="carousel-caption d-none d-md-block">
