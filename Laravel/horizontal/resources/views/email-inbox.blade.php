                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="email-leftbar card">
                            ...
                            <div class="mail-list m-t-20">
                                <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-info float-right mt-1 m-r-10"></span>Theme Support</a>
                                <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-warning float-right mt-1 m-r-10"></span>Freelance</a>
                                <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-primary float-right mt-1 m-r-10"></span>Social</a>
                                <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-danger float-right mt-1 m-r-10"></span>Friends</a>
                                <a href="#"><span class="mdi mdi-arrow-right-drop-circle text-success float-right mt-1 m-r-10"></span>Family</a>
                            </div>
                            ...
                            <div class="m-t-20">
                                <a href="#" class="media">
                                    <img class="d-flex mr-3 rounded-circle" src="{{url('/')}}/assets/images/users/user-2.jpg" alt="Generic placeholder image" height="36">
                                ...
                                <a href="#" class="media">
                                    <img class="d-flex mr-3 rounded-circle" src="{{url('/')}}/assets/images/users/user-3.jpg" alt="Generic placeholder image" height="36">
                                    <div class="media-body chat-user-box">
                                ...
                                <a href="#" class="media">
                                    <img class="d-flex mr-3 rounded-circle" src="{{url('/')}}/assets/images/users/user-4.jpg" alt="Generic placeholder image" height="36">
                                    <div class="media-body chat-user-box">
                                ...
                                <a href="#" class="media">
                                    <img class="d-flex mr-3 rounded-circle" src="{{url('/')}}/assets/images/users/user-6.jpg" alt="Generic placeholder image" height="36">
                                    <div class="media-body chat-user-box">
                            ...
                            <div class="card">
                                ...
                                <ul class="message-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="col-mail col-mail-2">
                                            <div class="subject"><span class="badge-primary badge mr-2">Social</span>This Week's Top Stories &nbsp;–&nbsp;
                                    ...
                                    <li>
                                        ...
                                        <div class="col-mail col-mail-2">
                                            <div class="subject"><span class="badge-danger badge mr-2">Friends</span>Weekend on Revibe &nbsp;–&nbsp;
                                    ...
                                    <li>
                                        ...
                                        <div class="col-mail col-mail-2">
                                            <div class="subject"><span class="badge-primary badge mr-2">Social</span>Task assigned: Clone ARP's website
